# -*- coding: utf-8 -*-
"""PlayerThreesOddsAPI.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GdunvzLefv1YjRz0Dh3KLPmSPCWlftmJ
"""
...
for i in range(len(df)):
  market = pd.DataFrame()
  print(i)
  url = "https://api.the-odds-api.com/v4/sports/basketball_nba/events/"+df['id'][i]+"/odds?apiKey=96e45b9af0dcb5961e81d736ca4d1b59&markets=player_threes&regions=us"
  # Send a GET request to the URL
  response = requests.get(url)
...
points.to_csv('/content/BetalyticsNBA/PlayerThreesOddsAPI.csv')
